...
| Mobile apps (iOS / Android)            | Strongly recommended     | Not a primary platform    | Delphi provides an integrated mobile framework (FMX). Rust can be used for mobile libraries, or embedded inside another stack |
